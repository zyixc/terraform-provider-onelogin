...
* `sso` - SSO credentials issued by OneLogin for the app. Computed and marked sensitive.
  * `client_id` - The OIDC client ID generated by OneLogin.
  * `client_secret` - The OIDC client secret generated by OneLogin. Only returned by the API at app creation; preserved in state on subsequent reads.
